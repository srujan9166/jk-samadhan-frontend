...
export default function Navbar({ onLodgeClick, onAppealClick, onTrackClick, onAuthClick, onFaqClick, onLmsClick, isLoggedIn, user, onLogout }) {
  ...
  return (
    <header className="w-full select-none font-sans z-50 relative bg-white">
      ...
      <div className="w-full bg-[#164581] text-white px-4 py-2 flex justify-between items-center text-[14px] font-verdana">
        ...
        <div className="hidden md:flex items-center gap-5">
          <div className="relative" ref={lmsRef}>
            ...
            {lmsOpen && (
              <div className="absolute left-0 mt-1 w-40 bg-white border border-slate-200 rounded-[4px] shadow-lg py-1 z-50 text-left font-sans">
                <button 
      ...
      <div className="w-full px-6 py-4 flex justify-between items-center border-b border-slate-100 bg-white animate-fadeIn">
        {/* Logo Section */}
          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-4">
              ...
              <button className="relative p-1.5 text-slate-500 hover:text-[#164581] rounded-full hover:bg-slate-100 transition-colors cursor-pointer border-0 bg-transparent" title="Notifications">
                ...
                <span className="absolute top-1 right-1 w-4.5 h-4.5 bg-red-600 text-white text-[9px] font-black rounded-full flex items-center justify-center border-2 border-white leading-none">
                  0
                </span>
              </button>
            ...
            <>
              ...
              <div className="relative" ref={loginRef}>
                ...
                {loginOpen && (
                  <div className="absolute right-0 mt-1 w-40 bg-white border border-slate-200 rounded-[4px] shadow-lg py-1 z-50 text-left font-sans">
                    <button 
        ...
        <div className="w-full flex justify-between items-center px-4">
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative" ref={grievanceRef}>
              ...
              {grievanceOpen && (
                <div className="absolute left-0 mt-1.5 w-48 bg-white border border-slate-200 rounded-[4px] shadow-lg py-1.5 z-50 text-left font-sans">
                  <button 
